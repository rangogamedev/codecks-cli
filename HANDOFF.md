...
Last updated: 2026-04-12 | Version: 0.5.0
...
### MCP Server (52 tools)
- 33 CodecksClient method wrappers + session/preference/planning tools
...
## Stats
- 1013 tests, 20 test files, 44 source modules
- 52 MCP tools, 33 CodecksClient methods
